...
flowchart LR
    ...
    subgraph SG_UTV_SYSTEM["🏗️ SYS"]
        ...
        UTV_BODY_CAD_README["UTV-BODY-CAD-README<br/>CAD — Carroceria"]
        ...
        UTV_BRAKES_CAD_README["UTV-BRAKES-CAD-README<br/>CAD — Freios"]
        ...
        UTV_CARGO_PLATFORM_CAD_README["UTV-CARGO-PLATFORM-CAD-README<br/>CAD — Plataforma de Carga"]
        ...
        UTV_CHASSIS_CAD_README["UTV-CHASSIS-CAD-README<br/>CAD — Chassis"]
        ...
        UTV_ELECTRICAL_CAD_README["UTV-ELECTRICAL-CAD-README<br/>CAD — Elétrica"]
        ...
        UTV_ERGONOMICS_CAD_README["UTV-ERGONOMICS-CAD-README<br/>CAD — Ergonomia"]
        UTV_POWERTRAIN_CAD_README["UTV-POWERTRAIN-CAD-README<br/>CAD — Powertrain"]
        ...
        UTV_STEERING_CAD_README["UTV-STEERING-CAD-README<br/>CAD — Direção"]
        ...
        UTV_SUSPENSION_CAD_README["UTV-SUSPENSION-CAD-README<br/>CAD — Suspensão"]
    end
